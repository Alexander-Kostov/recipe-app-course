package guru.framework.spring5_recipe_app.bootstrap;

import guru.framework.spring5_recipe_app.domain.*;
import guru.framework.spring5_recipe_app.repository.CategoryRepository;
import guru.framework.spring5_recipe_app.repository.RecipeRepository;
import guru.framework.spring5_recipe_app.repository.UnitOfMeasureRepository;
